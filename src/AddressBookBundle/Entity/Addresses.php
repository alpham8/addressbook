...
class Addresses
{
     ...
     *     message="Please provide an international phone number without a slash, dash, or white spaces or any other number that isn't a number. At the start, a plus sign is required."
     * )
     */
    private $phone;
